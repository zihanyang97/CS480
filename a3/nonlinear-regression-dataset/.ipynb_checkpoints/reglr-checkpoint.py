...
#1
    ...
    reg = linear_model.Ridge(alpha=1).fit(modifiedxTrain1, yTrain1)
...
#2
    ...
    reg = linear_model.Ridge(alpha=1).fit(modifiedxTrain2, yTrain2)
...
#3
    ...
    reg = linear_model.Ridge(alpha=1).fit(modifiedxTrain3, yTrain3)
...
#4
    ...
    reg = linear_model.Ridge(alpha=1).fit(modifiedxTrain4, yTrain4)
...
#5
    ...
    reg = linear_model.Ridge(alpha=1).fit(modifiedxTrain5, yTrain5)
...
#6
    ...
    reg = linear_model.Ridge(alpha=1).fit(modifiedxTrain6, yTrain6)
...
#7
    ...
    reg = linear_model.Ridge(alpha=1).fit(modifiedxTrain7, yTrain7)
...
#8
    ...
    reg = linear_model.Ridge(alpha=1).fit(modifiedxTrain8, yTrain8)
...
#9
    ...
    reg = linear_model.Ridge(alpha=1).fit(modifiedxTrain9, yTrain9)
...
#10
    ...
    reg = linear_model.Ridge(alpha=1).fit(modifiedxTrain10, yTrain10)
